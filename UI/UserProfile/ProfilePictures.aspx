<%@ Page Title="" Language="C#" MasterPageFile="~/UI/UserProfile/MasterPage.master" AutoEventWireup="true" CodeFile="ProfilePictures.aspx.cs" Inherits="UserProfile_ProfilePictures" %>
    ...
    <table class="style1">
        ...
        <tr>
            <td>
                &nbsp;</td>
            <td>
                     <asp:HyperLink ID="btncam" runat="server" NavigateUrl="#" 
                         style="font-weight: 700; font-size: medium;">Take a Photo</asp:HyperLink>
            </td>
            <td>
                &nbsp;</td>
            <td>

...
<body onload="Init();" style="background-color:#D9E8EF;">
    ...
    <table>
        <tr valign="top">
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Crop this Image
                ...
                <br />
                <center><div>
                    <asp:Button runat="server" ID="btnCrop" OnClick="btnCrop_Click" Text="Crop this Image" OnClientClick="return ValidateSelected();" />
                </div>
                </center>
            </td>
